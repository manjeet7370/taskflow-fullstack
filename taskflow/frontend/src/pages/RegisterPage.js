    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '24px', fontWeight: '700', color: '#1e293b' }}>Create Account</h1>
          <p style={{ margin: '8px 0 0', color: '#64748b', fontSize: '14px' }}>Join TaskFlow today</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input type="password" style={inputStyle(errors.password)}
              {...register('password', {
